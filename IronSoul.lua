...
Main:CreateToggle({
    ...
    Callback = function(val)
        autoKill = val
        Rayfield:Notify({
            Title   = val and "Auto Kill ON" or "Auto Kill OFF",
            Content = val and ("Радиус: " .. killRange .. "u") or "Остановлено",
            Duration = 3,
        })
    end,
})
...
Main:CreateButton({
    ...
    Callback = function()
        ...
        Rayfield:Notify({ Title = "Готово", Content = "Убито: " .. count, Duration = 3 })
    end,
})
